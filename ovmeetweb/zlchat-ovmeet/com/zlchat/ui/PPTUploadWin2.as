...
package com.zlchat.ui {
    ...
    public class PPTUploadWin2 extends ResizeWin {
        ...
        protected function onOK(_arg1:Event):void{
            ...
            nc.netGroup.post(new String(((((((((("<font size='+1' color='#ff0000'> " + "系统提示:") + "(") + ChatConnection.getChineseTime()) + "):</font>") + "<font size='+2' color='ff0000'> ") + nc.realName) + "已经打开PPT:") + pptPane.pptName) + "!</font><br>")));
        }
